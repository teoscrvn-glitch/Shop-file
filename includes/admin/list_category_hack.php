...
<style>
    ...
    @media (max-width: 576px){
        .cate-body{ padding: 14px; }
        .btn-add{ width:100%; justify-content:center; }
        .cate-actions{ width:100%; justify-content:flex-start; }
    }
</style>

<div class="container-fluid cate-wrap">
    <div class="row">
        <div class="col-12">
            ...
            <div class="cate-card">
                ...
                <div class="cate-head">
                    <div>
                        <h4 class="cate-title">Danh Mục</h4>
                        <p class="cate-sub">Quản lý danh mục hack game: xem, sửa, xóa — giao diện rõ ràng, mượt trên mọi thiết bị.</p>
                    </div>

                    <div class="cate-actions">
                        <a class="btn-add" href="main.php?action=add_category_hack">
                        ...
                        <div class="dropdown sub-dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dd1">
                                <a class="dropdown-item" href="main.php?action=add_category_hack">Tạo danh mục mới</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="table-shell">
                        <div class="table-responsive">
                            <table class="table table-modern no-wrap v-middle">
                                ...
                                <tbody>
                                    <?php foreach ($LOCNGUYEN_SIEUTHICODE->get_list("SELECT * FROM `tbl_category_hack` ORDER BY `stt` ASC") as $row) : ?>
                                        <tr>
                                            <td class="border-top-0"><span class="chip"><span class="dot"></span>#<?= $row['id'] ?></span></td>
                                            ...
                                            <td class="border-top-0">
                                                <div class="d-flex" style="gap:8px; flex-wrap:wrap;">
                                                    <a href="main.php?action=edit_category_hack&id=<?= $row['id'] ?>"
...
<script>
    function RemoveRow(id) {
        cuteAlert({
            ...
            if (e) {
                $.ajax({
                    url: "/ajaxs/action/removeCate.php",
                    method: "POST",
                    dataType: "JSON",
                    data: {
                        action: "delete",
